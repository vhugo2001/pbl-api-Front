...
import { Nav, Collapse, Navbar, Image, Row, Col, Dropdown, Container } from 'react-bootstrap'
        ...
        <Row className='BarMedidas RowPrincipal'>
                ...
                <Navbar className="flex-column sidenavigation" expand="lg" >
                    ...
                    <Nav className="flex-column SideNav mb-auto" >
                        ...
                        <Nav.Item className='SubMenusLaterais'>
                            <Image className='iconesSubMenu' src={require('../../Images/paperPlane.png')} />
                            <Link to='/teste' className='OpcoesLaterais'>Cadastrar PBL</Link>
                        </Nav.Item>
                        <Nav.Item className='SubMenusLaterais'>
                            <Image className='iconesSubMenu' src={require('../../Images/paperPlane.png')} />
                            <Link to='/consult' className='OpcoesLaterais'>Consultar PBL</Link>
                        </Nav.Item>

                        <Nav.Item className='MenusLaterais'>Aluno</Nav.Item>
                        <Nav.Item className='SubMenusLaterais'>
                            <Image className='iconesSubMenu' src={require('../../Images/paperPlane.png')} />
                            <Link to='/teste' className='OpcoesLaterais'>Cadastrar Aluno</Link>
                        </Nav.Item>
                        <Nav.Item className='SubMenusLaterais'>
                            <Image className='iconesSubMenu' src={require('../../Images/paperPlane.png')} />
                            <Link to='/consult' className='OpcoesLaterais'>Consultar Aluno</Link>
                        </Nav.Item>

                        <Nav.Item className='MenusLaterais'>Teste</Nav.Item>
                        <Nav.Item className='SubMenusLaterais'>
                            <Image className='iconesSubMenu' src={require('../../Images/paperPlane.png')} />
                            <Link to='/cadastro' className='OpcoesLaterais'>Cadastrar Empresa</Link>
                        </Nav.Item>
                        <Nav.Item className='SubMenusLaterais'>
                            <Image className='iconesSubMenu' src={require('../../Images/paperPlane.png')} />
                            <Link to='/' className='OpcoesLaterais'>Consultar Empresa</Link>
                        </Nav.Item>
                    </Nav>
                    {/* </Navbar.Collapse> */}
            ...
            <Col xs={7} sm={8} md={9} lg={10} xl={10} className='BarMedidas'>
                <Navbar className='topbar' expand="sm" variant="dark">
                    ...
                    <Dropdown>
                        <div class="dropdown-toggle iconesDrop" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <Image className='icones' src={require('../../Images/calendar.png')} />
                        </div>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <Link to='/teste' className='OpcoesLaterais dropdown-item'>Teste</Link>
                            <Link to='/login' className='OpcoesLaterais dropdown-item'>Login</Link>
                            <Link to='/' className='OpcoesLaterais dropdown-item'>Home</Link>
                        </div>
                    </Dropdown>
                    ...
                    <Dropdown>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <Link onClick={() => alert('Deslogado')} className='OpcoesLaterais dropdown-item'>Sair</Link>
                        </div>
                    </Dropdown>
